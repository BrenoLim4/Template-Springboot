...
public class TokenService {
    ...
    public static boolean isConvenente() {
        return getRoles().stream().anyMatch("CONVENIO.CONVENENTE"::equals);
    }

    public String getNomeCompleto(){
        return (String) getClaims().get("nomeCompleto");
    }

    public Claims getClaims(){
        return parseJwsClaim(getAuthorization().replace("Bearer ", ""), secret).getBody();
    }
}
